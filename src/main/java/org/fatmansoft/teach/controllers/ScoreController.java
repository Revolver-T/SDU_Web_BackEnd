...
//        return CommonMethod.getReturnData(form);//返回编辑数据
    ...
    public DataResponse scoreEditSubmit(@Valid@RequestBody DataRequest dataRequest)
    {
        ...
        Integer studentId = studentRepository.getStudentIdByStuName(studentName);
//        String studentId = CommonMethod.getString(form,"studentNum");//获取学生的id下同课程的id
        ...
        Integer courseId = courseRepository.getCourseIdByCourseNum(Integer.parseInt(courseNum));
...
//            c = courseRepository.findByCourseId(courseId).get();
